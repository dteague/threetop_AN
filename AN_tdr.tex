...
\hypersetup{%
  pdfauthor={Dylan Teague},%
  pdftitle={Measurement of the 3 Top Quark Production},%
  pdfsubject={CMS},%
  pdfkeywords={CMS}
}
...
%suppress warning about pdf figures in gcc (plots are rendered fine)
...
\bibliography{auto_generated} % this will be replaced with {auto_generated} when processed by tdr, which is a combination of all .bib files in the directory.
